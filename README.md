...
This is a Snips school timetable action written in Python and is compatible with `snips-skill-server`.

## Setup
### Prerequisites

You'll need to add the Stundenplan skill in your assistant. It's available on [Snips' console](https://console.snips.ai)
...
cd /var/lib/snips/skills/snips-skill-timetable/
sh setup.sh
